  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex h-full w-[380px] flex-col border-l border-white/20 bg-black/50">
          <div className="border-b border-white/10 p-4">
            <h2 className="text-lg font-semibold text-white">Writing Coach</h2>
          ...
          <div className="flex flex-col gap-2 border-b border-white/10 p-4">
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 rounded bg-blue-600 px-3 py-2 text-sm font-medium text-white transition-colors disabled:bg-gray-600 disabled:opacity-50 hover:bg-blue-700"
              >
                Discuss selection
              </button>
              <button
            ...
            <button
              ...
              disabled={isLoading}
              className="rounded bg-purple-600 px-3 py-2 text-sm font-medium text-white transition-colors disabled:bg-gray-600 disabled:opacity-50 hover:bg-purple-700"
            >
              Personalize
            </button>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded border border-white/20 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white/50 outline-none focus:border-white/40"
              />
              <button
                onClick={handleSend}
                disabled={!userMessage.trim() || isLoading}
                className="rounded bg-green-600 px-4 py-2 text-sm font-medium text-white transition-colors disabled:bg-gray-600 disabled:opacity-50 hover:bg-green-700"
              >
                Send
              </button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {chatMessages.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                {isLoading && (
                  <div className="rounded bg-white/5 p-3 text-sm text-white/60">
                    Thinking...
                  </div>
                )}
              </div>
